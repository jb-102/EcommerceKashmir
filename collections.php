...
<?php
  include("inc/db.php");
  $getcategory = "SELECT item_id, item_main_category , item_ist_view from products GROUP by item_main_category";
  $run = mysqli_query($con , $getcategory);

  while ($row = mysqli_fetch_array($run)) {
      $name = $row['item_main_category'];
      $image = $row['item_ist_view'];
...
?>        
  ...
  <div class="header">
    <h2 class="category-name"><a href="collections/accessories.html" title="Accessories"><?=$name?></a></h2>
  </div>
  ...
  <div class="footer">
    <a href="products.php?var_name=<?php echo "$name";?>" class="view-all">View all</a>
  </div>
