...
function addToCartSuccess (jqXHR, textStatus, errorThrown){
  ...
  var addcart_modal_numpro = ""; if ($(".num-items-in-cart span.number").html() ==1) addcart_modal_numpro = "There is 1 item in your cart."; else addcart_modal_numpro = "There are "+$(".num-items-in-cart span.number").html()+" items in your cart.";
