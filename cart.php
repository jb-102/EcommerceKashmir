...
?>
            ...
            <tr id="cart_row_<?=$get_id?>">
              ...
              <td class="item-price"><span class="money" id="product_price_<?=$get_id?>" data-currency-usd="$225.00" data-currency="USD">&#8377;<?="$get_product_price"?></span></td>
                ...
                <div class="quantity">
                        ...
                        <span class="qty-wrapper">
                            <span class="qty-inner">
                                ...
                                <span class="qty-up qty-up-cart" data-id="<?=$get_id?>" title="Increase" data-src="#quantity">
                                    <i class="fa fa-plus"></i>
                                </span>

                                <span class="qty-down qty-down-cart" data-id="<?=$get_id?>" title="Decrease" data-src="#quantity">
