...
<form method="post" id="cartform" rv-show="cart.item_count | gt 0" style="display: block;">
...
<?php
	...
	$get_item_id = "select * from user_cart";
...
?>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="item-price"><span class="money" data-currency-usd="$225.00" data-currency="USD">&#8377;<?="$get_product_price"?></span></td>
...
<script type="text/javascript">
    function get_item_id(productid){
        ...
        $.post('update_quantity.php',{prod_id:send_id},function(data){
            data = JSON.parse(data);
            console.log(data.item_name);
            $("#product-total").text(data.item_name);
            ...
            $("#qs-product-price").text(data.item_price);
              ...
              <td class="item-total"><span class="money" data-currency-usd="$675.00" id="product_total" data-currency="USD">&#8377;<?="$product_total" ; ?></span></td>
