    ...
    <ul class="breadcrumb">
		...
		<li itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			<a itemprop="url" href="../index.php">
				...
				<li class="active">Result for search Products are :</li>
...
<?php
  ...
  $get_name = $_POST['search_box'];
  $getproducts = "SELECT * FROM products WHERE ( item_main_category LIKE '%$get_name%' OR item_name LIKE '%$get_name%' OR item_category LIKE '%$get_name%' OR item_sub_category LIKE '%$get_name%')";
...
<div id="mailchimp-popup" style="display:none;" data-expires="1">
  ...
  Shopify.linkOptionSelectors = function(product) {
    ...
    <script type="text/javascript">
      jQuery(function() {
        CartJS.init({"token":"615419da4f765607446e4c539891028e","note":null,"attributes":{},"original_total_price":0,"total_price":0,"total_discount":0,"total_weight":0,"item_count":0,"items":[],"requires_shipping":false}, {
            dataAPI: true,
